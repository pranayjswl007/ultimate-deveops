...
A new promotion branch `{promo_branch}` has been created and [PR #{new_pr_number}](https://github.com/{repo}/pull/{new_pr_number}) has been opened.
...
if __name__ == "__main__":
    try:
        ...
        new_pr = create_promotion_pr(repo, promo_branch, base_branch, original_pr, gh_pat, has_conflict=False)
